    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publicity', models.CharField(choices=[('PB', 'Public'), ('OB', 'Observable'), ('PR', 'Private')], default='PB', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club_role', models.CharField(choices=[('AD', 'Admin'), ('PT', 'Participant'), ('RD', 'Reader'), ('OB', 'Observer')], default='RD', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('OP', 'Open'), ('VW', 'Viewed'), ('AC', 'Accepted'), ('RJ', 'Rejected')], default='OP', max_length=2)),
                ('requested', models.DateTimeField(default=datetime.datetime.now)),
                ('evaluated', models.DateTimeField(blank=True, null=True)),
                ('book_club', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='book_club.bookclub')),
                ('evaluator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='evaluator', to=settings.AUTH_USER_MODEL)),
                ('reader', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='requestor', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'unique_together': {('reader', 'book_club')},
            },
